                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={analytics.recentTrend} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                      ...
                      <Tooltip formatter={(value) => [value !== undefined ? `${value}%` : 'N/A', 'Score']} contentStyle={{ backgroundColor: '#fff', border: '1px solid #ccc' }} />
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={analytics.bySubject} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                      ...
                      <YAxis domain={[0, 100]} stroke="#9CA3AF" fontSize={11} unit="%" />
                      <Tooltip formatter={(value) => [value !== undefined ? `${value}%` : 'N/A', 'Avg Score']} contentStyle={{ backgroundColor: '#fff', border: '1px solid #ccc' }} />
